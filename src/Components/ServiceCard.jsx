...
const ServiceCard = ({service}) => {
   const {id,img,title,category, short_description,price} = service;
   console.log(id)
      ...
      <div>
         <div className="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
               ...
               <div className="p-6">
                  ...
                  <p className="block  text-base font-light leading-relaxed text-gray-700 antialiased h-28 md:h-32 lg:h-20">
                     {title}. <br /> {short_description}
                  </p>
